...
public:
    CMainParams() {
        ...
        genesis = CreateGenesisBlock(1686349948, 1, 50 * COIN);
        consensus.hashGenesisBlock = genesis.GetHash();
        assert(consensus.hashGenesisBlock == uint256S("0xe069993ef5a77e335b323938064ec71ea05073a01e49d1aaa92459c00c058021"));
...
public:
    explicit CRegTestParams(const RegTestOptions& opts)
    {
        ...
        genesis = CreateGenesisBlock(1686349948, 21, 50 * COIN);
        consensus.hashGenesisBlock = genesis.GetHash();
        assert(consensus.hashGenesisBlock == uint256S("0x4d764254f5be63f0d3231295076e2df75f1fb678447fdc2f9bf2b8d90df08927"));
        assert(genesis.hashMerkleRoot == uint256S("0x4a5e1e4baab89f3a32518a88c31bc87f618f76673e2cc77ab2127b7afdeda33b"));
